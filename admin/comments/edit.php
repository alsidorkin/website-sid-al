    ...
    <div class="posts col-8">
      ...
      <div class="row add-post">
        ...
        <form action="edit.php" method='post'>
          <!-- <div class="col mb-4">
            <input name='title' value='<?//= $comment ?>' type="text" class="form-control" placeholder="Название"
              aria-label="Название">
          </div> -->
          <div class="col">
      <label for="exampleInputEmail1" class="form-label">Email address</label>
      <input name="email" readonly value=" <?=$mail;?> " type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"placeholder="Введите вашу почту...">
      <div id="emailHelp" class="form-text"></div>
    </div>
          <input type="hidden" name='id' value="<?=$id ?>">
          <div class="col">
            <label for="editor" class="form-label ">Содержимое комментария</label>
            <textarea id='editor' name='comment' class="form-control" rows="6"><?=$text?></textarea>
          </div>
          <!-- <div class="input-group col mb-4 mt-4">
            <input type="file" name='img' class="form-control" id="inputGroupFile02">
            <label class="input-group-text" for="inputGroupFile02">Upload</label>
          </div> -->
          <!-- <select class="form-select mb-2" name='comment' aria-label="Default select example">
            <?php
          ...
          <div class="col col-6">
            <button class="btn btn-primary" name='comment_edit' type="submit">Сохранить запись</button>
          </div>
        </form>
      </div>
    </div>
